...
namespace CourseManagementAPI.Migrations
{
    ...
    [Migration("20260417224245_InitialIdentitySetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseManagementAPI.Models.Instructor", b =>
                {
                    b.HasOne("CourseManagementAPI.Models.User", "User")
                        .WithOne("Instructor")
                        .HasForeignKey("CourseManagementAPI.Models.Instructor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CourseManagementAPI.Models.Student", b =>
                {
                    b.HasOne("CourseManagementAPI.Models.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("CourseManagementAPI.Models.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CourseManagementAPI.Models.User", null)
                        .WithMany()
